 ...
 */
final class Version20230523114137 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE description2 description2 LONGTEXT NOT NULL, CHANGE description3 description3 LONGTEXT NOT NULL, CHANGE description4 description4 LONGTEXT NOT NULL, CHANGE essentiel essentiel LONGTEXT NOT NULL, CHANGE sous_categorie sous_categorie LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE description2 description2 VARCHAR(2000) DEFAULT NULL, CHANGE description3 description3 VARCHAR(2000) DEFAULT NULL, CHANGE description4 description4 VARCHAR(2000) DEFAULT NULL, CHANGE essentiel essentiel VARCHAR(2000) DEFAULT NULL, CHANGE sous_categorie sous_categorie VARCHAR(255) DEFAULT NULL');
    }
}
